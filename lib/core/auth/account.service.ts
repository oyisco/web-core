...
export class AccountService {
	...
	constructor(private http: HttpClient, @Inject(SERVER_API_URL_CONFIG) private apiUrlConfig: ServerApiUrlConfig) {
	}

	fetch(): Observable<HttpResponse<Account>> {
		return this.http.get<Account>(this.apiUrlConfig.SERVER_API_URL + 'api/account', {observe: 'response'});
	}
